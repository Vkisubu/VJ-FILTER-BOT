...
class script(object):
    START_TXT = """<b>Hᴇʟʟᴏ {},\nᴍʏ ɴᴀᴍᴇ <a href=https://t.me/{}>{}</a>, I Cᴀɴ Pʀᴏᴠɪᴅᴇ Mᴏᴠɪᴇs, Jᴜsᴛ Aᴅᴅ Mᴇ Tᴏ Yᴏᴜʀ Gʀᴏᴜᴘ As Aᴅᴍɪɴ Aɴᴅ Eɴᴊᴏʏ 😍</b>"""
...
Where is source code? - <a href='https://graph.org/file/c097b4ca7d563b79c69ed.gif'>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a>

Developer - <a href='https://t.me/IllegalDeveloperBot'>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a></b>"""
...
my features Stay here new features coming soon...  
 <b>✯ Maintained by : <a href=https://t.me/IllegalDeveloperBot>ɪʟʟᴇɢᴀʟ ᴅᴇᴠᴇʟᴏᴘᴇʀ</a></b>
  
 <b>✯ Join here : <a href=https://t.me/Illegal_Developers>☢Join My Updateds☢</a></b> 
...
ᴘʟᴇᴀꜱᴇ ᴄʜᴇᴄᴋ ᴛʜᴇ ꜱᴘᴇʟʟɪɴɢ ᴏɴ ɢᴏᴏɢʟᴇ ᴏʀ ɪᴍᴅʙ..."""
    ...
    MVE_NT_FND = """<b>ᴍᴏᴠɪᴇ ɴᴏᴛ ꜰᴏᴜɴᴅ ɪɴ ᴅᴀᴛᴀʙᴀꜱᴇ... \n\nYou Can Request Here For Uploaded @Illegal_Disscussion</b> \n\n**Note - **`plz Request Your Movie Name With #request`"""
...
🏦 ᴜᴘɪ ɪᴅ ➩ illegal.developer@axl [ɪғ ʀᴇǫᴜɪʀᴇᴅ]
...
Hey <a href='tg://settings'>My Friend</a> 
 ...
 Exp: /shortlink shareus.io xhMlwOvXzehIRx3SeCFS3ofgKk12
...
హే <a href='tg://settings'>My Friend</a> 
 ...
 దశ 1: ఈ 𝙸𝚕𝚕𝚎𝚐𝚊𝚕 𝙰𝚞𝚝𝚘 𝙵𝚒𝚕𝚝𝚎𝚛 𝙱𝚘𝚝 బాట్‌ని మీ సమూహానికి నిర్వహించండి

 దశ 2: మీ వెబ్‌సైట్ మరియు APIని జోడించండి

 గడువు: /shortlink shareus.io xhMlwOvXzehIRx3SeCFS3ofgKk12
...
अरे <a href='tg://settings'>My Friend</a> 
 ...
 चरण 1: इस 𝙸𝚕𝚕𝚎𝚐𝚊𝚕 𝙰𝚞𝚝𝚘 𝙵𝚒𝚕𝚝𝚎𝚛 𝙱𝚘𝚝 बॉट को अपने समूह में प्रशासित करें

 चरण 2: अपनी वेबसाइट और एपीआई जोड़ें

 एक्सप: /शॉर्टलिंक shareus.io xhMlwOvXzehIRx3SeCFS3ofgKk12
...
ഹേയ് <a href='tg://settings'>My Friend</a> 
 ...
 കാലഹരണപ്പെടൽ: /shortlink shareus.io xhMlwOvXzehIRx3SeCFS3ofgKk12
...
നിങ്ങളുടെ ടീം വീഡിയോ ശേഖരണവും പരിശീലിപ്പിക്കും..."""
 ...
 مرحلہ 1: اپنے گروپ میں اس 𝙸𝚕𝚕𝚎𝚐𝚊𝚕 𝙰𝚞𝚝𝚘 𝙵𝚒𝚕𝚝𝚎𝚛 𝙱𝚘𝚝 بوٹ کا انتظام کریں۔
...
نیز آپ کی ٹیم ویڈیو جمع کرنے کی تربیت دے گی..."""
    ...
    GUJARATI_INFO = """
ᴄʜᴏᴏsᴇ ʏᴏᴜʀ sᴜɪᴛᴀʙʟᴇ ᴘʟᴀɴ & ᴘᴀʏ ʏᴏᴜʀ ᴘʀᴇᴍɪᴜᴍ ғᴇᴇs ᴜsɪɴɢ ᴀɴʏ ᴜᴘɪ ᴀᴘᴘ. ɴᴏ ɴᴇᴇᴅ ᴛᴏ ᴇɴᴛᴇʀ ᴜᴘɪ ɪᴅ & ᴘʟᴀɴ ᴀᴍᴏᴜɴᴛ ᴍᴀɴᴜᴀʟʟʏ, ᴊᴜsᴛ ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ᴘʟᴀɴ ʙᴜᴛᴛᴏɴ.
...
আরে <a href='tg://settings'>My Friend</a> 
 ...
 ধাপ 1: আপনার গ্রুপে এই 𝙸𝚕𝚕𝚎𝚐𝚊𝚕 𝙰𝚞𝚝𝚘 𝙵𝚒𝚕𝚝𝚎𝚛 𝙱𝚘𝚝 বট পরিচালনা করুন

 ধাপ 2: আপনার ওয়েবসাইট এবং API যোগ করুন

 মেয়াদ: /shortlink shareus.io xhMlwOvXzehIRx3SeCFS3ofgKk12
...
-Dev 1 [Owner of this bot ]<a href='https://t.me/Illegal_Developers'>ɪʟʟᴇɢᴀʟ ᴅᴇᴠᴇʟᴏᴘᴇʀ 🇮🇳</a>

-Dev 2 <a href='https://t.me/Illegal_Developers'>ɪʟʟᴇɢᴀʟ ᴅᴇᴠᴇʟᴏᴘᴇʀ</a>

-Dev 3 <a href='https://t.me/Illegal_Developers'>ɪʟʟᴇɢᴀʟ ᴅᴇᴠᴇʟᴏᴘᴇʀ</a>

- Dev 4 <a href='https://t.me/Illegal_Developers'>ɪʟʟᴇɢᴀʟ ᴅᴇᴠᴇʟᴏᴘᴇʀ</a>
"""
