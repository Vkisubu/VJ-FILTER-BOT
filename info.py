...
MELCOW_VID = environ.get("MELCOW_VID", "https://t.me/KSeriesFilm/5")
...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '5140601098 5283274789').split()]
auth_channel = environ.get('AUTH_CHANNEL')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001646481513')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001940974146')
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = bool(environ.get("NO_RESULTS_MSG", False))

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://kknkt2654826:851130@cluster0.h90vtvy.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "kknkt2654826")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/IllegalSupportGroup')
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001799594060'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'IllegalSupportGroup')
