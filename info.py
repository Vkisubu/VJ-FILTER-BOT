...
URL = "https://vj-bot.herokuapp.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://vj-bot.herokuapp.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://vj-bot.herokuapp.com/".format(FQDN)
else:
    URL = "https://vj-bot.herokuapp.com/".format(FQDN)
